...
function MainSlide(props) {
  ...
  return (
    <div className={`main-slider__slide main-slider__slide--${currentSlide.name}`}>
      <div
        className={`main-slider__gradient-container main-slider__gradient-container--${currentSlide.name}`}
      >
        <div
          className={`main-slider__background-container main-slider__background-container--${currentSlide.name}`}
        >
        </div>
      </div>
      <div className={`main-slider__container main-slider__container--${currentSlide.name}`}>
        ...
        <p className={`main-slider__slogan main-slider__slogan--${currentSlide.name}`}>
          {currentSlide.slogan}
        </p>
        {currentSlide.link && (
          <a
